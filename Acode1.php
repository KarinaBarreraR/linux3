...
$$tags2[$i]=$valores2[$i]; 
	...
	$consulta="DELETE FROM docentes WHERE iddocente = '$IDBusqueda'";
	$resul=mysql_query($consulta);

  $consulta="DELETE FROM asignaturas WHERE docente = '$IDBusqueda'";
  $resul=mysql_query($consulta);
?>
...
<title>.. Eliminaci&oacute;n de Docente en  la Plataforma Lyons ..</title>
...
<table width="993" height="585" align="center" cellpadding="0" cellspacing="0" background="imagenes/fond.png">
  <tbody><tr>
	  <td width="991" height="19" colspan="3" align="left" valign="top">&nbsp;</td>
			</tr>


  <tr>
    <td height="110" colspan="3" align="right" valign="top"><table width="101%" height="149" align="left" cellpadding="0" cellspacing="0" background="REVISTA DINERS_files/cabezote_naraja22.png">
      <tbody>
        <tr>
          <td valign="bottom" width="1%" height="147">&nbsp;</td>
          <td width="12%">&nbsp;</td>
          <td width="87%"><p>&nbsp;</p>
              <p>&nbsp;</p>
            <p>&nbsp;</p></td>
  ...
  <tr>
    <td height="430" colspan="3" class="fondocwentro"><table width="92%" height="409" cellpadding="0" cellspacing="0">
      <tbody><tr>
							<td width="999" height="388" align="left" valign="top"><table width="981" height="371" border="0">
                              <tr>
                                <td width="1001" height="367" valign="top"><form id="form1" name="form1" method="post" action="">
                                  <table width="963" height="185" border="0">
                                    <tr>
                                      <td height="20" colspan="5" valign="top"><div align="center"><span class="Estilo11">Bienvenido(a), <? echo $_SESSION["nombre"] ?></span> <span class="Estilo11">a la Plataforma Lyons.</span></div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      <td height="21" colspan="5"><label>
                                        ...
                                        <div align="center"><span class="TITULOart2">Se ha Eliminado el Docente con Exito.</span></div>                                        
