...
include("config.php");
if (!$idasignatura||!$nombreasigantura||!$jornada||!$docente||!$grado){
	header("Location:codigoguardar_error_asignatura.php");
	exit;
}
...
$consulta="DELETE FROM asignaturas WHERE idasignatura = '$idasignatura'";
$resul=mysql_query($consulta);

mysql_select_db ($basededatos, $conexion);
$consulta="INSERT INTO `colegiosanjose`.`asignaturas` (
`idasignatura` ,
`nombreasignatura` ,
`jornada` ,
`docente` ,
...
VALUES ('$idasignatura', '$nombreasigantura', '$jornada', '$docente', '$grado')";

$resul=mysql_query($consulta);

if (!$resul){
	header("Location:error_guardar.php?error=".mysql_error());	
}
?>
...
<title>.. Ingreso de Asignatura a la Plataforma Lyons ..</title>
...
<table width="985" height="554" align="center" cellpadding="0" cellspacing="0" background="imagenes/fond.png">
  <tbody><tr>
  ...
  <tr>
    <td height="142" colspan="3" align="right" valign="top"><table width="101%" height="131" align="left" cellpadding="0" cellspacing="0" background="REVISTA DINERS_files/cabezote_naraja22.png">
      <tbody>
        <tr>
          <td valign="bottom" width="1%" height="115">&nbsp;</td>
          <td width="12%">&nbsp;</td>
          <td width="87%"><p>&nbsp;</p>
              <p>&nbsp;</p>
            <p>&nbsp;</p></td>
  ...
  <tr>
    <td height="389" colspan="3" class="fondocwentro"><table width="97%" height="389" cellpadding="0" cellspacing="0">
      <tbody><tr>
							<td width="973" height="373" align="left" valign="top"><table width="972" height="373" border="0">
                              <tr>
                                <td width="966" height="369" valign="top"><form id="form1" name="form1" method="post" action="">
                                  <table width="963" height="190" border="0">
                                    ...
                                    <tr>
                                      <td height="21" colspan="5"><p align="center" class="TITULOart2"><span class="TITULOart2"><img src="imagenes/dialog-apply copia.PNG" width="128" height="128" /></span></p>                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="21" colspan="5"><label>
                                        </label>
                                        <div align="center"><span class="TITULOart2">Se Ha Guardado Con Exito la Asignatura</span></div>                                        
                                    ...
                                    <tr>
                                      ...
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="fmenuTop Estilo18"><a href="plataformaindex_directivos.php"><img src="imagenes/go-home.png" width="50" height="50" border="0" /></a></span></div></td>
                                    </tr>
                                  </table>
                                                                </form>
                                </td>
...
<script>eplAD4("074c0ded835b6184",3,0,1)</script></td>
  </tr>  
</tbody></table>
