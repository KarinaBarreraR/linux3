...
<title>.. Ingreso de Docente a la Plataforma Lyons ..</title>
...
<table width="971" height="597" align="center" cellpadding="0" cellspacing="0" background="imagenes/fond.png">
  <tbody><tr>
  ...
  <tr>
    <td height="110" colspan="3" align="right" valign="top"><table width="101%" height="146" align="left" cellpadding="0" cellspacing="0" background="REVISTA DINERS_files/cabezote_naraja22.png">
      <tbody>
        <tr>
          <td valign="bottom" width="1%" height="144">&nbsp;</td>
          <td width="12%">&nbsp;</td>
          <td width="87%"><p>&nbsp;</p>
              <p>&nbsp;</p>
            <p>&nbsp;</p></td>
  ...
  <tr>
    <td height="442" colspan="3" class="fondocwentro"><table width="58%" height="402" cellpadding="0" cellspacing="0">
      <tbody><tr>
							<td width="969" height="388" align="left" valign="top"><table width="969" height="426" border="0">
                              <tr>
                                <td width="963" height="422" valign="top"><form id="form1" name="form1" method="post" action="">
                                  <table width="964" height="213" border="0">
                                    <tr>
                                    ...
                                    <tr>
                                      <td height="21"><div align="center"><span class="fmenuTop Estilo18 Estilo20"><a href="plataformaindex_directivos_ingresodocente.php" class="TITULOart1">INGRESAR DOCENTE </a></span></div></td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="fmenuTop Estilo18"><a href="plataformaindex_directivos_modificardocente.php">MODIFICAR DOCENTE </a></span></div></td>
                                      <td>&nbsp;</td>
                                      <td><div align="center"><span class="fmenuTop Estilo18"><a href="plataformaindex_directivos_eliminardocente.php">ELIMINAR DOCENTE </a></span></div></td>
                                    </tr>
                                    <tr>
                                      <td height="21" colspan="5"><p align="center" class="TITULOart2"><img src="imagenes/advertencia.png" width="128" height="128" /></p>                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="21" colspan="5"><label>
                                        </label>
                                        <div align="center"><span class="TITULOart2">Por Favor Ingrese Todos Los Campos Requeridos en el Formulario.</span></div>                                        
                                    ...
                                    <tr>
                                      <td><div align="center"><a href="javascript:history.back(1)"><img src="imagenes/atras.png" width="50" height="50" border="0" /></a></div></td>
                                      <td bordercolor="#FFFFFF">&nbsp;</td>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                      <td><div align="center" class="fmenuTop Estilo18"><a href="plataformaindex_directivos.php"><img src="imagenes/go-home.png" width="50" height="50" border="0" /></a></div></td>
                                    </tr>
                                  </table>
                                                                </form>
                                </td>
