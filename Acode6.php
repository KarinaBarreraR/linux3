...
<table width="971" height="596" align="center" cellpadding="0" cellspacing="0" background="imagenes/fond.png">
  <tbody><tr>
  ...
  <tr>
    <td height="110" colspan="3" align="right" valign="top"><table width="101%" height="131" align="left" cellpadding="0" cellspacing="0" background="REVISTA DINERS_files/cabezote_naraja22.png">
      <tbody>
        <tr>
  ...
  <tr>
    <td height="442" colspan="3" class="fondocwentro"><table width="97%" height="402" cellpadding="0" cellspacing="0">
      <tbody><tr>
                              ...
                              <tr>
                                <td width="963" height="422" valign="top"><form id="form1" name="form1" method="post" action="">
                                  <table width="963" height="190" border="0">
                                    ...
                                    <tr>
                                      <td height="21"><div align="center"><a href="javascript:history.back(1)"><img src="imagenes/atras.png" width="50" height="50" border="0" /></a></div></td>
